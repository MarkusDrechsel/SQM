...
public class DataInitializer {
    ...
    private List<StduyPlanEntity> studyplans;

    private List<Semester> semesters;

    private List<Subjcet> subjects;
    ...
    private Map<String, Subjcet> subjectsMandatoryBachelorSoftwareAndInformationEngineeringSemester1 = new HashMap<String, Subjcet>() {
        {
            put("VU Programmkonstruktion", new Subjcet("VU Programmkonstruktion", new BigDecimal(8.8)));
            put("UE Studieneingangsgespräch", new Subjcet("UE Studieneingangsgespräch", new BigDecimal(0.2)));
            put("VU Technische Grundlagen der Informatik", new Subjcet("VU Technische Grundlagen der Informatik", new BigDecimal(6.0)));
            put("VO Algebra und Diskrete Mathematik für Informatik und Wirtschaftsinformatik", new Subjcet("VO Algebra und Diskrete Mathematik für Informatik und Wirtschaftsinformatik", new BigDecimal(4.0)));
            put("UE Algebra und Diskrete Mathematik für Informatik und Wirtschaftsinformatik", new Subjcet("UE Algebra und Diskrete Mathematik für Informatik und Wirtschaftsinformatik", new BigDecimal(5.0)));
            put("VU Formale Modellierung", new Subjcet("VU Formale Modellierung", new BigDecimal(3.0)));
            put("VU Datenmodellierung", new Subjcet("VU Datenmodellierung", new BigDecimal(3.0)));
        }
    };

    private Map<String, Subjcet> subjectsMandatoryBachelorSoftwareAndInformationEngineeringSemester2 = new HashMap<String, Subjcet>() {
        {
            put("VU Algorithmen und Datenstrukturen 1", new Subjcet("VU Algorithmen und Datenstrukturen 1", new BigDecimal(6.0)));
            put("VU Algorithmen und Datenstrukturen 2", new Subjcet("VU Algorithmen und Datenstrukturen 2", new BigDecimal(3.0)));
            put("VU Einführung in Visual Computing", new Subjcet("VU Einführung in Visual Computing", new BigDecimal(6.0)));
            put("VU Gesellschaftliche Spannungsfelder der Informatik", new Subjcet("VU Gesellschaftliche Spannungsfelder der Informatik", new BigDecimal(3.0)));
            put("VU Basics of Human Computer Interaction", new Subjcet("VU Basics of Human Computer Interaction", new BigDecimal(3.0)));
            put("VO Analysis für Informatik und Wirtschaftsinformatik", new Subjcet("VO Analysis für Informatik und Wirtschaftsinformatik", new BigDecimal(2.0)));
            put("UE Analysis für Informatik und Wirtschaftsinformatik", new Subjcet("UE Analysis für Informatik und Wirtschaftsinformatik", new BigDecimal(4.0)));
            put("VU Objektorientierte Modellierung", new Subjcet("VU Objektorientierte Modellierung", new BigDecimal(3.0)));
        }
    };

    private Map<String, Subjcet> subjectsMandatoryBachelorSoftwareAndInformationEngineeringSemester3 = new HashMap<String, Subjcet>() {
        {
            put("VU Objektorientierte Programmiertechniken", new Subjcet("VU Objektorientierte Programmiertechniken", new BigDecimal(3.0)));
            put("VU Funktionale Programmierung", new Subjcet("VU Funktionale Programmierung", new BigDecimal(3.0)));
            put("VO Betriebssysteme", new Subjcet("VO Betriebssysteme", new BigDecimal(2.0)));
            put("UE Betriebssysteme", new Subjcet("UE Betriebssysteme", new BigDecimal(4.0)));
            put("VU Introduction to Security", new Subjcet("VU Introduction to Security", new BigDecimal(3.0)));
            put("VU Daten- und Informatikrecht", new Subjcet("VU Daten- und Informatikrecht", new BigDecimal(3.0)));
            put("VU Datenbanksysteme", new Subjcet("VU Datenbanksysteme", new BigDecimal(6.0)));
            put("VO Statistik und Wahrscheinlichkeitstheorie", new Subjcet("VO Statistik und Wahrscheinlichkeitstheorie", new BigDecimal(3.0)));
            put("UE Statistik und Wahrscheinlichkeitstheorie", new Subjcet("UE Statistik und Wahrscheinlichkeitstheorie", new BigDecimal(3.0)));
        }
    };

    private Map<String, Subjcet> subjectsMandatoryBachelorSoftwareAndInformationEngineeringSemester4 = new HashMap<String, Subjcet>() {
        {
            put("VU Einführung in die Künstliche Intelligenz", new Subjcet("VU Einführung in die Künstliche Intelligenz", new BigDecimal(3.0)));
            put("VU Theoretische Informatik und Logik", new Subjcet("VU Theoretische Informatik und Logik", new BigDecimal(6.0)));
            put("VO Software Engineering und Projektmanagement", new Subjcet("VO Software Engineering und Projektmanagement", new BigDecimal(3.0)));
            put("PR Software Engineering und Projektmanagement", new Subjcet("PR Software Engineering und Projektmanagement", new BigDecimal(6.0)));
        }
    };

    private Map<String, Subjcet> subjectsMandatoryBachelorSoftwareAndInformationEngineeringSemester5 = new HashMap<String, Subjcet>() {
        {
            put("VO Verteilte Systeme", new Subjcet("VO Verteilte Systeme", new BigDecimal(3.0)));
            put("UE Verteilte Systeme", new Subjcet("UE Verteilte Systeme", new BigDecimal(3.0)));
            put("VU Gesellschaftswissenschaftliche Grundlagen der Informatik", new Subjcet("VU Gesellschaftswissenschaftliche Grundlagen der Informatik", new BigDecimal(3.0)));
            put("VU Interface and Interaction Design", new Subjcet("VU Interface and Interaction Design", new BigDecimal(3.0)));
            put("VU Einführung in wissensbasierte Systeme", new Subjcet("VU Einführung in wissensbasierte Systeme", new BigDecimal(3.0)));
            put("SE Wissenschaftliches Arbeiten", new Subjcet("SE Wissenschaftliches Arbeiten", new BigDecimal(3.0)));
        }
    };

    private Map<String, Subjcet> subjectsMandatoryBachelorSoftwareAndInformationEngineeringSemester6 = new HashMap<String, Subjcet>() {
        {
            put("PR Bachelorarbeit für Informatik und Wirtschaftsinformatik", new Subjcet("PR Bachelorarbeit für Informatik und Wirtschaftsinformatik", new BigDecimal(10.0)));
        }
    };

    private Map<String, Subjcet> subjectsOptionalBachelorSoftwareAndInformationEngineering = new HashMap<String, Subjcet>() {
        {
            put("VU Propädeutikum für Informatik", new Subjcet("VU Propädeutikum für Informatik", new BigDecimal(6.0)));
            put("VO Deklaratives Problemlösen", new Subjcet("VO Deklaratives Problemlösen", new BigDecimal(3.0)));
            put("UE Deklaratives Problemlösen", new Subjcet("UE Deklaratives Problemlösen", new BigDecimal(3.0)));
            put("VU Logikprogrammierung und Constraints", new Subjcet("VU Logikprogrammierung und Constraints", new BigDecimal(6.0)));
            put("VO Abstrakte Maschinen", new Subjcet("VO Abstrakte Maschinen", new BigDecimal(3.0)));
            put("UE Abstrakte Maschinen", new Subjcet("UE Abstrakte Maschinen", new BigDecimal(3.0)));
            put("VU Microcontroller", new Subjcet("VU Microcontroller", new BigDecimal(7.0)));
            put("UE Programmierung von Betriebssystemen", new Subjcet("UE Programmierung von Betriebssystemen", new BigDecimal(3.0)));
            put("VU Übersetzerbau", new Subjcet("VU Übersetzerbau", new BigDecimal(6.0)));
            put("VO Echtzeitsysteme", new Subjcet("VO Echtzeitsysteme", new BigDecimal(2.0)));
            put("VU Dependable Systems", new Subjcet("VU Dependable Systems", new BigDecimal(4.0)));
            put("VU Internet Security", new Subjcet("VU Internet Security", new BigDecimal(3.0)));
            put("VU Internet Security", new Subjcet("VU Internet Security", new BigDecimal(3.0)));
            put("VU Privacy Enhancing Technology", new Subjcet("VU Privacy Enhancing Technology", new BigDecimal(3.0)));
            put("UE Daten- und Informatikrecht", new Subjcet("UE Daten- und Informatikrecht", new BigDecimal(3.0)));
            put("VU Vertrags- und Haftungsrecht", new Subjcet("VU Vertrags- und Haftungsrecht", new BigDecimal(3.0)));
            put("VU Semistrukturierte Daten", new Subjcet("VU Semistrukturierte Daten", new BigDecimal(3.0)));
            put("VU Web Engineering", new Subjcet("VU Web Engineering", new BigDecimal(4.5)));
            put("VU Computerstatistik", new Subjcet("VU Computerstatistik", new BigDecimal(3.0)));
            put("VU Datenanalyse", new Subjcet("VU Datenanalyse", new BigDecimal(3.0)));
            put("VU Statistical Computing", new Subjcet("VU Statistical Computing", new BigDecimal(3.0)));
            put("VO Logik für Wissensrepräsentation", new Subjcet("VO Logik für Wissensrepräsentation", new BigDecimal(3.0)));
            put("UE Logik für Wissensrepräsentation", new Subjcet("UE Logik für Wissensrepräsentation", new BigDecimal(3.0)));
            put("VO Computernumerik", new Subjcet("VO Computernumerik", new BigDecimal(3.0)));
            put("UE Computernumerik", new Subjcet("UE Computernumerik", new BigDecimal(1.5)));
            put("VO Multivariate Statistik", new Subjcet("VO Multivariate Statistik", new BigDecimal(4.5)));
            put("UE Multivariate Statistik", new Subjcet("UE Multivariate Statistik", new BigDecimal(1.5)));
            put("VU Statistische Simulation und computerintensive Methoden", new Subjcet("VU Statistische Simulation und computerintensive Methoden", new BigDecimal(3.0)));
            put("VU Argumentieren und Beweisen", new Subjcet("VU Argumentieren und Beweisen", new BigDecimal(6.0)));
            put("VU Programm- und Systemverifikation", new Subjcet("VU Programm- und Systemverifikation", new BigDecimal(6.0)));
            put("VU Softwareprojekt-Beobachtung und -Controlling", new Subjcet("VU Softwareprojekt-Beobachtung und -Controlling", new BigDecimal(6.0)));
            put("VU Software-Qualitätssicherung", new Subjcet("VU Software-Qualitätssicherung", new BigDecimal(6.0)));
            put("VU Usability Engineering", new Subjcet("VU Usability Engineering", new BigDecimal(3.0)));
            put("SE Coaching als Führungsinstrument 2", new Subjcet("SE Coaching als Führungsinstrument 2", new BigDecimal(3.0)));
            put("SE Didaktik in der Informatik", new Subjcet("SE Didaktik in der Informatik", new BigDecimal(3.0)));
            put("VO EDV-Vertragsrecht", new Subjcet("VO EDV-Vertragsrecht", new BigDecimal(1.5)));
            put("VO Einführung in Technik und Gesellschaft", new Subjcet("VO Einführung in Technik und Gesellschaft", new BigDecimal(3.0)));
            put("SE Folgenabschätzung von Informationstechnologien", new Subjcet("SE Folgenabschätzung von Informationstechnologien", new BigDecimal(3.0)));
            put("VU Forschungsmethoden", new Subjcet("VU Forschungsmethoden", new BigDecimal(3.0)));
            put("VU Kommunikation und Moderation", new Subjcet("VU Kommunikation und Moderation", new BigDecimal(3.0)));
            put("VU Kooperatives Arbeiten", new Subjcet("VU Kooperatives Arbeiten", new BigDecimal(3.0)));
            put("SE Rechtsinformationsrecherche im Internet", new Subjcet("SE Rechtsinformationsrecherche im Internet", new BigDecimal(3.0)));
            put("VU Softskills für TechnikerInnen", new Subjcet("VU Softskills für TechnikerInnen", new BigDecimal(3.0)));
            put("VU Techniksoziologie und Technikpsychologie", new Subjcet("VU Techniksoziologie und Technikpsychologie", new BigDecimal(3.0)));
            put("VO Theorie und Praxis der Gruppenarbeit", new Subjcet("VO Theorie und Praxis der Gruppenarbeit", new BigDecimal(3.0)));
            put("SE Wissenschaftliche Methodik", new Subjcet("SE Wissenschaftliche Methodik", new BigDecimal(3.0)));
            put("SE Scientific Presentation and Communication", new Subjcet("SE Scientific Presentation and Communication", new BigDecimal(3.0)));
            put("PV Privatissimum aus Fachdidaktik Informatik", new Subjcet("PV Privatissimum aus Fachdidaktik Informatik", new BigDecimal(4.0)));
            put("VU Präsentation und Moderation", new Subjcet("VU Präsentation und Moderation", new BigDecimal(3.0)));
            put("VO Deduktive Datenbanken", new Subjcet("VO Deduktive Datenbanken", new BigDecimal(2.0)));
        }
    };

    private Map<String, Subjcet> subjectsFreeChoiceInformatics = new HashMap<String, Subjcet>() {{
        put("VU Pilots in Mobile Interaction: User-centered Interaction Research and Evaluation", new Subjcet("VU Pilots in Mobile Interaction: User-centered Interaction Research and Evaluation", new BigDecimal(3.0)));
        put("VU Robotik für RoboCup", new Subjcet("VU Robotik für RoboCup", new BigDecimal(6.0)));
        put("KO Reflections on ICTs and Society", new Subjcet("KO Reflections on ICTs and Society", new BigDecimal(6.0)));
        put("VU Science of Information 1: Transdisciplinary Foundations of Informatics", new Subjcet("VU Science of Information 1: Transdisciplinary Foundations of Informatics", new BigDecimal(3.0)));
        put("VU Parallel Computing", new Subjcet("VU Parallel Computing", new BigDecimal(6.0)));
        put("PR Praktikum aus IT-Security", new Subjcet("PR Praktikum aus IT-Security", new BigDecimal(6.0)));
        put("SE Formale Semantik natürlicher Sprache", new Subjcet("SE Formale Semantik natürlicher Sprache", new BigDecimal(3.0)));
        put("VO Ausgewählte Kapitel der Technischen Informatik", new Subjcet("VO Ausgewählte Kapitel der Technischen Informatik", new BigDecimal(3.0)));
        put("SE Seminar für DiplomandInnen", new Subjcet("SE Seminar für DiplomandInnen", new BigDecimal(2.0)));
        put("SE Computer Vision Seminar für DiplomandInnen", new Subjcet("SE Computer Vision Seminar für DiplomandInnen", new BigDecimal(2.0)));
        ...
        put("VU Advanced Services Engineering", new Subjcet("VU Advanced Services Engineering", new BigDecimal(3.0)));
        put("SE Forschungsseminar für DiplomandInnen", new Subjcet("SE Forschungsseminar für DiplomandInnen", new BigDecimal(3.0)));
        put("VO Finanzmärkte, Finanzintermediation und Kapitalanlage", new Subjcet("VO Finanzmärkte, Finanzintermediation und Kapitalanlage", new BigDecimal(3.5)));
        put("VU Methodisches, industrielles Software-Engineering mit Funktionalen Sprachen am Fallbeispiel Haskell", new Subjcet("VU Methodisches, industrielles Software-Engineering mit Funktionalen Sprachen am Fallbeispiel Haskell", new BigDecimal(3.0)));
        put("VU IT Governance", new Subjcet("VU IT Governance", new BigDecimal(3.0)));
        put("VU Current Trends in Computer Science", new Subjcet("VU Current Trends in Computer Science", new BigDecimal(3.0)));
        put("VU Programmierung von Strategie-Spielen", new Subjcet("VU Programmierung von Strategie-Spielen", new BigDecimal(3.0)));
        put("VU Medienanalyse und Medienreflexion", new Subjcet("VU Medienanalyse und Medienreflexion", new BigDecimal(3.0)));
        put("EX Exkursion", new Subjcet("EX Exkursion", new BigDecimal(3.0)));
        put("VU Privacy Enhancing Technologies", new Subjcet("VU Privacy Enhancing Technologies", new BigDecimal(3.0)));
        put("VU Theoretische Informatik und Logik für CI", new Subjcet("VU Theoretische Informatik und Logik für CI", new BigDecimal(6.0)));
        put("SE Theorie und Praxis der Evaluierung von innovativen User Interfaces", new Subjcet("SE Theorie und Praxis der Evaluierung von innovativen User Interfaces", new BigDecimal(3.0)));
        put("VU Brückenkurs Programmierung für Studienanfängerinnen", new Subjcet("VU Brückenkurs Programmierung für Studienanfängerinnen", new BigDecimal(3.0)));
        put("VU Mobile (App) Software Engineering", new Subjcet("VU Mobile (App) Software Engineering", new BigDecimal(3.0)));
        put("VU Runtime Verification", new Subjcet("VU Runtime Verification", new BigDecimal(3.0)));
        put("VU 2D and 3D Image Registration", new Subjcet("VU 2D and 3D Image Registration", new BigDecimal(3.0)));
        put("VU Mobile Robotik", new Subjcet("VU Mobile Robotik", new BigDecimal(4.5)));
        put("SE Critical Algorithm Studies", new Subjcet("SE Critical Algorithm Studies", new BigDecimal(3.0)));
        put("VU Brückenkurs Programmierung für Studienanfänger", new Subjcet("VU Brückenkurs Programmierung für Studienanfänger", new BigDecimal(3.0)));
    }};

    private Map<String, Subjcet> subjectsBachelorSoftwareAndInformationEngineering;

    private Map<String, Lehrveranstaltung> coursesBachelorSoftwareAndInformationEngineering;
    ...
    private Map<String, StudentEntity> studentMap = new HashMap<String, StudentEntity>() {
        {
            put("Caroline Black", new StudentEntity("s1123960", "Caroline Black", "caroline.black@uis.at", new UserAccountEntity("student", "pass", Rolle.STUDENT)));
            put("Emma Dowd", new StudentEntity("s1127157", "Emma Dowd", "emma.dowd@gmail.com", new UserAccountEntity("emma", "pass", Rolle.STUDENT)));
            put("John Terry", new StudentEntity("s1126441", "John Terry", "john.terry@uis.at", new UserAccountEntity("john", "pass", Rolle.STUDENT)));
            put("Joan Watson", new StudentEntity("s0227157", "Joan Watson", "joan.watson@uit.at"));
            put("James Bond", new StudentEntity("s1527199", "James Bond", "jamesbond_007@yahoo.com"));
            put("Trevor Bond", new StudentEntity("s0445157", "Trevor Bond", "trevor@uis.at"));
            put("Mathematician", new StudentEntity("s0000001", "Diego Costa", "diego.cost@yahoo.com", new UserAccountEntity("diego", "pass", Rolle.STUDENT)));
            put("SimilarToMathematician", new StudentEntity("s0000002", "Cesc Fabregas", "cesc.fabregas@yahoo.com", new UserAccountEntity("cesc", "pass", Rolle.STUDENT)));
            put("NewStudent", new StudentEntity("s0000003", "Eden Hazard", "eden.hazard@yahoo.com", new UserAccountEntity("eden", "pass", Rolle.STUDENT)));
        }
    };

    private Map<String, LecturerEntity> lecturerMap = new HashMap<String, LecturerEntity>() {
        {
            put("Carol Sanderson", new LecturerEntity("l0100010", "Carol Sanderson", "carol@uis.at"));
            put("Una Walker", new LecturerEntity("l0100011", "Una Walker", "una.walker@uis.at", new UserAccountEntity("lecturer", "pass", Rolle.LECTURER)));
            put("Connor MacLeod", new LecturerEntity("l0203019", "Connor MacLeod", "connor@gmail.com"));
            put("Eric Wilkins", new LecturerEntity("l1100010", "Eric Wilkins", "e1234567@tuwien.ac.at", new UserAccountEntity("eric", "pass", Rolle.LECTURER)));
            put("Benjamin Piper", new LecturerEntity("l9123410", "Benjamin Piper", "ben@uis.at", new UserAccountEntity("ben", "pass", Rolle.LECTURER)));
        }
    };
    ...
    private void createSubjects() {
        ...
        Iterable<Subjcet> subjects = subjectRepository.save(subjectsBachelorSoftwareAndInformationEngineering.values());
    ...
    private void createSemesters() {
        Iterable<Semester> semesters = semesterRepository.save(asList(
                ...
                new Semester(2017, SemestreTypeEnum.SummerSemester)
        ));
    ...
    private void createCourses() {
        ...
        Collection<Lehrveranstaltung> courses = coursesBachelorSoftwareAndInformationEngineering.values();

        this.courses = StreamSupport.stream(courseRepository.save(courses).spliterator(), false).collect(Collectors.toList());
    }
    ...
    private void createCoursesBachelorSoftwareAndInformationEngineering() {
        ...
        for (String subjectName : subjectsBachelorSoftwareAndInformationEngineering.keySet()) {
            Subjcet subject = subjectsBachelorSoftwareAndInformationEngineering.get(subjectName);

            Lehrveranstaltung course = new Lehrveranstaltung(subject, semesters.get(2));
    ...
    private void createStudyPlans() {
        Iterable<StduyPlanEntity> studyplans = studyPlanRepository.save(asList(
                new StduyPlanEntity("Bachelor Software and Information Engineering", new EtcsDistributionEntity(new BigDecimal(136), new BigDecimal(30), new BigDecimal(14))),
                new StduyPlanEntity("Master Business Informatics", new EtcsDistributionEntity(new BigDecimal(30), new BigDecimal(70), new BigDecimal(20))),
                new StduyPlanEntity("Master Computational Intelligence", new EtcsDistributionEntity(new BigDecimal(60), new BigDecimal(30), new BigDecimal(30))),
                new StduyPlanEntity("Master Visual Computing", new EtcsDistributionEntity(new BigDecimal(60), new BigDecimal(30), new BigDecimal(30))),
                new StduyPlanEntity("Master Medical Informatics", new EtcsDistributionEntity(new BigDecimal(60), new BigDecimal(30), new BigDecimal(30)), false),
                new StduyPlanEntity("Master Computer Science", new EtcsDistributionEntity(new BigDecimal(60), new BigDecimal(30), new BigDecimal(30)))
        ));
    ...
    private void createUsers() {
        pendingAccountActivationRepository.save(
                new PendingAcountActivation("test", new StudentEntity("test", "Test User", "test-user@uis.at"))
        );
    ...
    private void registerSubjectsToLecturers() {
        ...
        Subjcet s = subjectsBachelorSoftwareAndInformationEngineering
    ...
    private void registerCoursesToStudents() {
        ...
        StudentEntity similarToMathematician = studentMap.get("SimilarToMathematician");
    ...
    private void register(StudentEntity student, Lehrveranstaltung course) {
        course.addStudents(student);
        studentSubjectPreferenceStore.studentRegisteredCourse(student, course);
    }

    private void giveGrades() {
        Lehrveranstaltung course = coursesBachelorSoftwareAndInformationEngineering.get("UE Studieneingangsgespräch");
        StudentEntity student = course.getStudents().get(0);
        LecturerEntity lecturer = course.getSubject().getLecturers().get(0);

        Grade grade = new Grade(course, lecturer, student, MarkEntity.EXCELLENT);
    ...
    private void giveFeedback() {
        Lehrveranstaltung course = coursesBachelorSoftwareAndInformationEngineering.get("VU Datenmodellierung");
