...
public class AdminUsersTest {
    ...
    private List<UisUserEntity> users = new ArrayList<>();

    @Before
    public void setUp() throws Exception {
        IntStream.range(0, 100).forEach(it -> {
            UisUserEntity user = it % 2 == 0 ?
                    new StudentEntity("s" + it, "student" + it, "smail" + it + "@uis.at") :
                    new LecturerEntity("l" + it, "lecturer" + it, "lmail" + it + "@uis.at");
    ...
    private MockHttpServletRequestBuilder listUsers() {
        return get("/admin/users").with(user("admin").roles(Rolle.ADMIN.name()));
    }
    ...
    public void itSearchesUsersByNameIgnoringCase() throws Exception {
        List<UisUserEntity> usersWithName = users.stream()
    ...
    public void itSearchesUsersByMailIgnoringCase() throws Exception {
        List<UisUserEntity> usersWithMail = users.stream()
    ...
    public void adminShouldSeeStudentDetailsTest() throws Exception {
        ...
        // given 3 study plans
        StduyPlanEntity studyPlan1 = studyPlanRepository.save(new StduyPlanEntity("SE", new EtcsDistributionEntity(new BigDecimal(60), new BigDecimal(30), new BigDecimal(30))));
        StduyPlanEntity studyPlan2 = studyPlanRepository.save(new StduyPlanEntity("VC", new EtcsDistributionEntity(new BigDecimal(60), new BigDecimal(30), new BigDecimal(30))));
        studyPlanRepository.save(new StduyPlanEntity("CI", new EtcsDistributionEntity(new BigDecimal(60), new BigDecimal(30), new BigDecimal(30))));
    ...
    public void adminShouldSeeLecturerDetailsTest() throws Exception {
        ...
        LecturerEntity lecturer = uisUserRepository.save(new LecturerEntity("l12345", "lecturer", "l12345@uis.at"));
        Subjcet maths = new Subjcet("maths", new BigDecimal(6.0));
        Subjcet df = new Subjcet("digital forensics", new BigDecimal(6.0));
