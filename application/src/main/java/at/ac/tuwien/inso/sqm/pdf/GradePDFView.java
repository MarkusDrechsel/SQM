...
public class GradePDFView extends AbstractPdfView {
    ...
    private static final Font TITLE_FONT = FontFactory.getFont(FontFactory.HELVETICA /*FontFactory.HELVETICA_BOLD*/, 30);
    ...
    private Table createTable(Grade grade) throws BadElementException {
        ...
        studentId.add(new Paragraph(grade.getStudent().getIdentificationNumber()));
        */
    ...
    private Paragraph generateFooter() {
        String footerText = "This document was created on " + LocalDate.now().format(DateTimeFormatter.ofPattern("dd-MM-yyyy"));
